...
<head>
    ...
    <title>Jungle Aventure - El Juego de Aventura en la Selva</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <style>
        @import url('https://fonts.googleapis.com/css2?family=Bungee&family=Patrick+Hand&display=swap');
        ...
        * {
        ...
        header {
            background: linear-gradient(to bottom, #2a8d5a, #1d5f3a);
            color: white;
            padding: 20px 0;
            position: relative;
            overflow: hidden;
...
<body>
    ...
    <script>
        ...
        document.getElementById('downloadBtn').addEventListener('click', function(e) {
            ...
            // Crear una notificación de descarga
